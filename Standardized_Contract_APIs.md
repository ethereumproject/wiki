...
The standards described below have sample implementations available [here](https://github.com/ethereumproject/dapp-bin/tree/master/standardized_contract_apis).
